    ...
    public :
        ...
        virtual void setValue(bool val, int pin) {
            ...
            if ( pin == 0 ) {
                ...
                if ( pin == 2 ) dec2_4[0] ->setValue(val , pin);
                else if ( pin == 3 ) dec2_4[0] ->setValue(val , pin);
            }
...
int main() {
    ...
    decoder.setEnable(true); 

    decoder.setValue(false, 0);  // I0 = 1
    decoder.setValue(false, 1);  // I1 = 1
    decoder.setValue(true, 2); // I2 = 0
    decoder.setValue(false, 3); // I3 = 0
    
    cout << decoder << endl;

    int outputValue = decoder.output();
